		  ...
		  <div class="row">
			...
			<div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
			  ...
			  <div class="d-lg-flex">
				...
				<a href="https://www.youtube.com/watch?v=-hLeCPEU6s0" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"> Regarder Video <i class="icofont-play-alt-2"></i></a>
			  </div>
			</div>
