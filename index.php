		...
		<div class="container">
		  <div class="row">
			...
			<div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
			  <h1>Serveur Rôleplay vLife</h1>
			  <h2>Serveur GTA V sur les services de secours.<br>
			  <i><small>Nous ne sommes associés à aucun service de secours</small></i></h2>
			   
			  <div class="d-lg-flex">
				<a href="recrutement/" class="btn-get-started scrollto">Nous Rejoindre</a>
				<a href="https://www.youtube.com/watch?v=AhbEm_Aibuk" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"> Regarder Video <i class="icofont-play-alt-2"></i></a>
			  </div>
			</div>
			...
			<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-app">
				...
				<div class="portfolio-info">
				  <h4>Pompier 1</h4>
				  <p>Pompier</p>
				  <a href="assets/img/portfolio/portfolio-1.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Pompier 1"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-1.jpg" download="Pompier 1 - vLife" class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-web">
				...
				<div class="portfolio-info">
				  <h4>SAMU 1</h4>
				  <p>SAMU</p>
				  <a href="assets/img/portfolio/portfolio-2.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="SAMU 1"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-2.jpg" download="SAMU 1 - vLife" class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-app">
				...
				<div class="portfolio-info">
				  <h4>Pompier 2</h4>
				  <p>Pompier</p>
				  <a href="assets/img/portfolio/portfolio-3.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Pompier 2"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-3.jpg" download = "Pompier 2 - vLife"class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-card">
				...
				<div class="portfolio-info">
				  <h4>Police 1</h4>
				  <p>Police</p>
				  <a href="assets/img/portfolio/portfolio-4.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Police 1"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-4.jpg" download="Police 1 - vLife"class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-web">
				...
				<div class="portfolio-info">
				  <h4>SAMU 2</h4>
				  <p>SAMU</p>
				  <a href="assets/img/portfolio/portfolio-5.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Samu 2"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-5.jpg" download="SAMU 2 - vLife" class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-app">
				...
				<div class="portfolio-info">
				  <h4>Pompier 3</h4>
				  <p>Pompier</p>
				  <a href="assets/img/portfolio/portfolio-6.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Pompier 3"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-6.jpg" download ="Pompier 3 - vLife" class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-card">
				...
				<div class="portfolio-info">
				  <h4>Police 2</h4>
				  <p>Police</p>
				  <a href="assets/img/portfolio/portfolio-7.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Police 2"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-7.jpg" download ="Police 2 - vLife" class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-card">
				...
				<div class="portfolio-info">
				  <h4>Police 3</h4>
				  <p>Police</p>
				  <a href="assets/img/portfolio/portfolio-8.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Police 3"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-8.jpg" download="Police 3 - vLife" class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
			  ...
			  <div class="col-lg-4 col-md-6 portfolio-item filter-web">
				...
				<div class="portfolio-info">
				  <h4>Samu 3</h4>
				  <p>Samu</p>
				  <a href="assets/img/portfolio/portfolio-9.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Samu 3"><i class="bx bx-plus"></i></a>
				  <a href="assets/img/portfolio/portfolio-9.jpg" download="Samu 3 - vLife" class="details-link" title="Télécharger"><i class="bx bx-link"></i></a>
				</div>
			  </div>
		...
		<section id="team" class="team section-bg">
		  <div class="container" data-aos="fade-up">
			  ...
			  <div class="col-lg-6">
				<div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
				  ...
				  <div class="member-info">
					...
					<div class="social">
					  <a href="https://twitter.com/vLifeRoleplay" target="_blank"><i class="ri-twitter-fill"></i></a>
					  <a href="https://www.youtube.com/channel/UCGIaj2gVvI2P49KcdKPHUJQ" target="_blank"><i class="ri-youtube-fill"></i></a>
					  <a href="https://www.instagram.com/vliferoleplay/" target="_blank"><i class="ri-instagram-fill"></i></a>
					  <a href="https://www.facebook.com/VLIFE-Roleplay-105971311109637" target="_blank"><i class="ri-facebook-fill"></i></a>
					</div>
				  </div>
				</div>
			  </div>
				...
				<div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
				  ...
				  <div class="member-info">
					...
					<div class="social">
					  ...
					  <a href="https://www.twitch.tv/wallbang_r6" target="_blank"><i class="ri-twitch-fill"></i></a>
			...
			<div class="carousel-item">
			  ...
			  <div class="col-lg-6">
				<div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
				  <div class="pic"><img src="assets/img/team/team-9.png" class="img-fluid" alt=""></div>
				  <div class="member-info">
					<h4 class="staff">Joe Camsur</h4>
					<span>Commissaire de Police - Chef de la circonscription d’Aulnay-Sous-Bois du serveur.</span>
					<p>Professionnel du métier depuis 2014. Il a su lier sa passion pour le Roleplay et son métier qu’il affectionne.</p>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="col-lg-6 mt-4 mt-lg-0">
				<div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
				  <div class="pic"><img src="assets/img/team/team-10.png" class="img-fluid" alt=""></div>
				  <div class="member-info">
			  ...
			  <div class="col-lg-6 mt-4">
				<div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
				  <div class="pic"><img src="assets/img/team/team-11.png" class="img-fluid" alt=""></div>
				  <div class="member-info">
		  ...
		  | Membres <a class="tip" data-toggle="tooltip" data-placement="bottom" title="Constitué des moddeurs ou développeur du serveur">Pôle technique</a> <i class="circle yellow"></i></p></div>
			  ...
			  <div class="col-lg-6 mt-5 mt-lg-0 d-flex align-items-stretch">
				...
				<form role="form" action="forms/form-process.php" id="contactForm" data-toggle="validator" class="php-email-form">
				  <div class="form-row">
					...
					echo ' <input type="email" class="form-control" name="email" id="email" data-rule="email" data-msg="Merci d\'entrer un email" />';
					}
					  ?>
					  <div class="validate"></div>
					</div>
				  ...
				  <div class="form-group">
					...
					<textarea class="form-control" name="message" rows="10" data-rule="required" data-msg="Veuillez remplir cette partie"></textarea>
					<div class="validate"></div>
				  </div>
				  <div class="mb-3">
